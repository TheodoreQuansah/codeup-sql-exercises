...
SELECT emp_no, first_name, last_name 
FROM employees WHERE first_name IN ('Irena', 'Vidya') OR  first_name = 'maya'; 
-- '10200','10397','10610'.
...
FROM employees WHERE first_name IN ('Irena', 'Vidya', 'Maya') AND gender = 'm'; 
-- '10200','10397''10821'
...
SELECT last_name 
FROM employees WHERE last_name LIKE '%e' AND first_name NOT LIKE 'e%';

Find all unique last names that start and end with 'E'.
SELECT last_name 
FROM employees WHERE last_name LIKE '%e' AND 'e%';

Find all current or previous employees hired in the 90s. Enter a comment with top three employee numbers.
SELECT last_name, first_name, hire_date 
FROM employees WHERE hire_date BETWEEN '1990-01-01' AND '1999-12-31';
-- '10008', '10011', '10012'
